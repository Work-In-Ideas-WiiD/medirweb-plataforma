                                    ...
                                    <div class="col-md-3">
	            						...
	            						<i class="fa fa-retweet"></i> Leitura
											...
											<i class="fa fa-close"></i> Corte
                                                ...
                                                <p>ID: #{{ $unidade->id_hidrometro }}</p>

                                            </div>
                                            <div class="col col-md-6 leitura">
                                                <p class="small">@if($unidade->tipo == 2) <i class="fa fa-fire" aria-hidden="true"></i> Consumo - Gás</p> @elseif($unidade->tipo == 3) <i class="fa fa-bolt" aria-hidden="true"></i> Consumo - Energia</p> @else <i class="fa fa-bath" aria-hidden="true"></i> Consumo - Água</p> @endif
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1" style="margin: 0; padding-left: 3px;">
                                                        @if($unidade->tipo == 3)
                                                            ...
                                                            <p style="line-height: 1.0em; text-decoration: none; cursor: default; color: #fff;">wh</p>
