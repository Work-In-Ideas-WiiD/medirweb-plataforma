            ...
            foreach ($hidromentros as $hidromentro) {
                ...
                if(isset($leituraAnterior) && isset($leituraAtual)) {
                    ...
                    $relatorio_consumoAvancados = array(
                        ...
                        'data_leitura_anterior' => date('Y-08-05', strtotime($leituraAnterior->created_at)), //$leituraAnterior->created_at,
                        'data_leitura_atual' => Carbon::parse(strtotime($leituraAtual->created_at))->addMonths(1)->format('Y-09-05'), //date('Y-m-6', strtotime($leituraAtual->created_at)), // $leituraAtual->created_at,
                    );
