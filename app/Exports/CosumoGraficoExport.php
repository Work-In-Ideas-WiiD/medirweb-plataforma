...
class CosumoGraficoExport implements FromArray
{
    ...
    public function array(): array
    {
        ...
        $sheets = array(0 => array('Imovel' => $imovel->nome,), 1 => array(''), 2 => array('Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro'), 3 => array(''));
